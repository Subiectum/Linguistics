...
\begin{table}[H]
\centering
\footnotesize % 使用更小的字号
\setlength{\tabcolsep}{2pt} % 减少列间距
\renewcommand{\arraystretch}{1.3} % 增加行高

\begin{tabularx}{\textwidth}{|>{\bfseries}l|*{4}{>{\footnotesize}X|}>{\footnotesize}X|>{\footnotesize}X|>{\footnotesize}X|>{\footnotesize}X|}
\hline
\multicolumn{1}{|c|}{} & \multicolumn{4}{c|}{\textbf{Indicative}} & \multicolumn{2}{c|}{\textbf{Subjunctive}} & \textbf{Conditional} & \textbf{Imperative} \\
\cline{2-9}
\multicolumn{1}{|c|}{} & \textbf{Present} & \textbf{\shortstack{Simple\\past}} & \textbf{Imperfect} & \textbf{Future} & \textbf{Present} & \textbf{\shortstack{Imperfect\\subj.}} & \textbf{Present} & \textbf{Present} \\
\hline
je & 1S+e/s/x & PAST+ai/s & 1P+ais & FUT+ai & SUBJ+e & PAST+()sse & FUT+rais & -- \\
\hline
tu & 1S+es/s/x & PAST+a(s) & 1P+ais & FUT+as & SUBJ+es & PAST+()sses & FUT+rais & \shortstack[l]{1S+s/t\\or\\SUBJ+e} \\
\hline
il/elle & 1S+e/t/- & PAST+a/t & 1P+ait & FUT+ra & SUBJ+e & PAST+(\^{})t & FUT+rait & -- \\
\hline
nous & 1P+ons & PAST+(\^{})mes & 1P+ions & FUT+rons & \shortstack[l]{SUBJ+ions\\or\\1P+ions} & PAST+()ssions & FUT+rions & \shortstack[l]{1P+ons\\or\\SUBJ+ons} \\
\hline
vous & 1P+ez & PAST+(\^{})tes & 1P+iez & FUT+rez & \shortstack[l]{SUBJ+iez\\or\\1P+iez} & PAST+()ssiez & FUT+riez & \shortstack[l]{1P+ez\\or\\SUBJ+ez} \\
\hline
ils/elles & 3P+ent & PAST+(\^{})rent & 1P+aient & FUT+ront & SUBJ+ent & PAST+()ssent & FUT+raient & -- \\
\hline
\end{tabularx}
