...
\begin{tabular}{| L{3.5cm} | L{3cm} | L{2.5cm} | L{4cm} |}
\hline
...
\vspace{1cm} % Add some space before the next table

\begin{tabular}{| L{3.5cm} | L{3cm} | L{2.5cm} | L{4cm} |}
\hline
\multicolumn{2}{|c|}{\textbf{VERBES}} & \textbf{INFINITIF} & \textbf{EXEMPLES} \\
\hline
\textbf{d’ordre ou d’influence :} & conseiller (\textit{à}) (\textit{de}), convaincre (\textit{de}), dire (\textit{à}) (\textit{de}), interdire (\textit{à}) (\textit{de}), obliger (\textit{à}), ordonner (\textit{à}) (\textit{de}), permettre (\textit{à}) (\textit{de}) & complément direct ou oblique & Luc permet à Max [de partir]. Luc oblige Max [à partir]. \\
\hline
\textbf{de perception :} & écouter, entendre, observer, regarder, sentir, voir & complément oblique & Luc entend Max [chanter un air]. \\
\hline
\end{tabular}
