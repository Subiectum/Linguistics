...
\hline % 表格顶部的横线
\rowcolor{headerblue} \textbf{VALENCE} & \textbf{EXEMPLES} \\
\hline
\multicolumn{2}{|>{\RaggedRight}p{15cm}|}{\textbf{sans complément :}} \\ % 跨越两列的子表头，居中或左对齐取决于\RaggedRight
\hline
arriver, survenir & [Qu'il neige en avril] arrive parfois. \\
\hline
\multicolumn{2}{|>{\RaggedRight}p{15cm}|}{\textbf{avec un complément nominal :}} \\
\hline
alourdir, améliorer, amuser, causer, changer, constituer, couter, ennuyer, entraîner, étonner, impliquer, nécessiter, réclamer, réjouir, résoudre, signifier, supposer, valoir & [Que Marie soit partie] complique [les choses]. \newline [Que Marie soit partie] ennuie [Paul]. \newline [Partir demain] réclame [toute une organisation]. \\
\hline
\multicolumn{2}{|>{\RaggedRight}p{15cm}|}{\textbf{avec un complément prépositionnel :}} \\
\hline
conduire (à), convenir (à), découler (de), dépendre (de), déplaire (à), importer (à), influer (sur), plaire (à), suffire (à), sortir, venir (de) & [Persévérer] conduirait [à l'échec]. \newline [Que Marie soit partie] déplaît [à Paul]. \\
\hline
\multicolumn{2}{|>{\RaggedRight}p{15cm}|}{\textbf{avec un complément infinitif ou phrastique :}} \\
\hline
commencer (à), conduire (à), être, finir (par), ressembler (à), revenir (à) & [Souffler] n'est pas [ jouer]. \newline [Partir] reviendrait [à démissionner]. \newline [Que tout va mal] commence [à se savoir]. \\
\hline % 表格底部的横线
\end{tabular}
\end{table}
