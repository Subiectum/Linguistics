...
\begin{table}[H]
    ...
    \hline
    \raisebox{2.5ex}[0pt][0pt]{date} & antériorité & \textit{avant, jusqu'à, d'ici, \% endéans} & \textit{avant le dîner, d'ici la fin du mois, \% endéans la fin du mois} \\
    \cline{2-4}
     & simultanéité, inclusion & \textit{à, vers, en même temps (que), au moment (de), du temps (de)} & \textit{vers midi, du temps des Croisades} \\
    \cline{2-4}
     & postériorité & \textit{après, dès, depuis, à compter (de), à partir (de), suite à (de), \% endéans} & \textit{depuis hier, à compter d'aujourd'hui} \\
    \hline
    \raisebox{2.5ex}[0pt][0pt]{durée} & antériorité & \textit{il y a, voici, voilà} & \textit{il y a un mois, voici trois ans} \\
    \cline{2-4}
     & simultanéité, inclusion & \textit{avant, dans, de, depuis, d'ici, durant, en, par, pour, au cours (de), pendant, sous, \% endéans} & \textit{avant huit jours, de toute la nuit, depuis des années, dans les trois jours, d'ici une semaine, sous huit jours, \% endéans la quinzaine} \\
    \cline{2-4}
     & postériorité & \textit{après, dans, au bout (de)} & \textit{dans trois jours} \\
    \hline
    \end{tabular}
\end{table}
