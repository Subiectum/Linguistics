...
\centering
\centering
\fontsize{8pt}{10pt}\selectfont % Reduce font size for the entire table

\setlength{\tabcolsep}{3pt} % Reduce column separation

\begin{tabular}{|l|p{1.4cm}|p{1.6cm}|p{1.4cm}|p{1.4cm}|p{1.4cm}|p{1.6cm}|p{1.4cm}|p{2cm}|}
\hline
...
\hline
\textbf{je} & & & & \textbf{FUT}+ai & \textbf{SUBJ}+e & \textbf{PAST}+sse & & \\
\cline{1-1}\cline{5-9} % Partial line for 'je' row
\textbf{tu} & \textbf{1S}+s & \textbf{PAST}+s & \textbf{1P}+ais & \textbf{FUT}+as & \textbf{SUBJ}+es & \textbf{PAST}+sses & \textbf{FUT}+ais & \textbf{1S}+s / \\
& & & & & & & & \textbf{1S}+t \textit{or} \\
& & & & & & & & \textbf{SUBJ}+e \\
\hline
\textbf{il/elle} & \textbf{1S}+t & \textbf{PAST}+t & \textbf{1P}+ait & \textbf{FUT}+a & \textbf{SUBJ}+e & \textbf{PAST}+t & \textbf{FUT}+ait & \\
\hline
\textbf{nous} & \textbf{1P}+ons & \textbf{PAST}+mes & \textbf{1P}+ions & \textbf{FUT}+ons & \textbf{SUBJ}+ions & \textbf{PAST}+ssions & \textbf{FUT}+ions & \textbf{1P}+ons \textit{or} \\
& & & & & \textit{or} \textbf{1P}+ions & & & \textbf{SUBJ}+ons \\
\hline
\textbf{vous} & \textbf{1P}+ez & \textbf{PAST}+tes & \textbf{1P}+iez & \textbf{FUT}+ez & \textbf{SUBJ}+iez & \textbf{PAST}+ssiez & \textbf{FUT}+iez & \textbf{1P}+ez \textit{or} \\
& & & & & \textit{or} \textbf{1P}+iez & & & \textbf{SUBJ}+ez \\
\hline
\textbf{ils/elles} & \textbf{3P}+ent & \textbf{PAST}+rent & \textbf{1P}+aient & \textbf{FUT}+ont & \textbf{SUBJ}+ent & \textbf{PAST}+ssent & \textbf{FUT}+aient & \\
\hline
\end{tabular}
\end{table}
