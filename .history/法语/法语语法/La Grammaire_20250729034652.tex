...
\begin{enumerate}
    \item Les ajouts conditionnels sans introducteur, 主句动词必须用conditionnel形式，否则只能解释为causale ou temporelle
    \begin{itemize}
...
\paragraph{Le mode et l’introducteur de la conditionnelle}
