...
\subsubsection{L’adverbe comparatif ajout à la phrase}
...
\begin{table}[H]
    ...
    \textbf{CATÉGORIE} & \textbf{FORMES} & \textbf{EXEMPLES} \\
    \hline
    adjectif & autre, même, \%pareil, tel & Le problème est tel [que vous l'avez décrit]. \\
    & & Cela relève d'une autre approche [que la vôtre]. \\
    \hline
    adverbe & ainsi, autrement, \%différemment, \%pareillement & J'agirai autrement [qu'il y a vingt ans]. \\
    \hline
    préposition ou syntagme prépositionnel & ailleurs, de la même façon, de la même manière, de même, d'une autre façon, d'une autre manière, etc. & J'irai ailleurs [qu'à la montagne]. \\
    & & Cette pâte durcit de la même façon [que l'argile]. \\
    \hline
    pronom & autre chose, autre part & Je veux autre chose [qu'un livre]. \\
    \hline
    \end{tabular}
