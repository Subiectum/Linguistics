...
\cline{2-9}
\multicolumn{1}{|c|}{} & \textbf{Present} & \textbf{Simple past} [\textbf{PAST}] & \textbf{Imperfect} & \textbf{Future} & \textbf{Present} & \textbf{Imperfect} & \textbf{Present} & \textbf{Present} \\
\hline
\textbf{je} & \textbf{1S}+e/s/x & +ai/s &\textbf{1P}+ais & \textbf{FUT}+ai & \textbf{3P/SUBJ}+e & \textbf{PAST}+()sse & \textbf{FUT}+rais & \\
\hline % Full line after je row
\textbf{tu} & \textbf{1S}+es/s/x & \textbf{PAST}+a(s) & \textbf{1P}+ais & \textbf{FUT}+as & \textbf{3P/SUBJ}+es & \textbf{PAST}+()sses & \textbf{FUT}+rais & \textbf{1S}+s/t \textbf{SUBJ}+e\\
\hline
\textbf{il/elle} & \textbf{1S}+e/t/- & \textbf{PAST}+a/t & \textbf{1P}+ait & \textbf{FUT}+ra & \textbf{3P/SUBJ}+e & \textbf{PAST}+(\^{})t & \textbf{FUT}+rait & \\
\hline
\textbf{nous} & \textbf{1P}+ons & \textbf{PAST}+ (\^{})mes & \textbf{1P}+ions & \textbf{FUT}+rons & \textbf{1P/SUBJ} +ions& \textbf{PAST}+ ()ssions & \textbf{FUT}+rions & \textbf{1P}+ons  \textit{or} \textbf{SUBJ}+ons \\

\hline
\textbf{vous} & \textbf{1P}+ez & \textbf{PAST}+ (\^{})tes & \textbf{1P}+iez & \textbf{FUT}+rez & \textbf{1P/SUBJ} +iez & \textbf{PAST}+ ()ssiez & \textbf{FUT}+riez & \textbf{1P}+ez  \textit{or} \textbf{SUBJ}+ez \\

\hline
\textbf{ils/elles} & \textbf{3P}+ent & \textbf{PAST}+ (\^{})rent & \textbf{1P}+aient & \textbf{FUT}+ront & \textbf{3P/SUBJ}+ ent & \textbf{PAST}+ ()ssent & \textbf{FUT}+raient & \\
\hline
\end{tabularx}
\end{table}
