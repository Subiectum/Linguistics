...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \end{enumerate}
    \end{enumerate}
    \itme 只有introduites par un mot relatif ou un syntagme contenant un mot relatif的从句动词才可用infinitif
    \begin{itemize}
...
\begin{table}[H]
    \centering
    \begin{longtable}{|m{4cm}|m{3cm}|m{7cm}|}
    \hline
    \rowcolor{cyan!20}
