...
\centering
\footnotesize % Try \footnotesize (even smaller than \small, typically 8pt or less)

\setlength{\tabcolsep}{2pt} % Reduce column separation even further
...
% Using X columns for most, but give the last column (Imperative) slightly more weight.
\begin{tabularx}{\textwidth}{|l|X|X|X|X|X|X|X|X*1.2|} % X*1.2 gives the last column 20% more space
\hline
...
& & & & & \textit{or} \textbf{1P}+iez & & &  \textbf{SUBJ}+ez \\ % Added missing \textbf{SUBJ}+ez
\hline
