...
\begin{table}[H]
    ...
    \textbf{CATÉGORIE} & \textbf{FONCTION} & \textbf{POSITION} & \textbf{EXEMPLES} \\
    \hline
    \rule{0pt}{1.5ex}ADJECTIF, ADVERBE, DÉTERMINANT, NOM & spécifieur du nom & début de syntagme & [le] médecin, [mon] ami \\
    & & & [pareille] aventure \\
    & & & [beaucoup] de bruit, [nombre] de difficultés \\
    \hline
    ...
    \hline
    \rule{0pt}{1.5ex}SA, NOM, SN, SUBORDONNÉE RELATIVE & ajout au nom ou au SN & après le nom & une table [longue de 2 mètres] \\
    & & & une fiche [incident], mon ami [le médecin] \\
    & & & la table [que j'ai] \\
    \hline
    \rule{0pt}{1.5ex}CONJONCTION DE COORDINATION OU PRÉPOSITION & marqueur & début de syntagme & Jean [et] Paul \\
    & & & beaucoup [de] bruit, une place [de] libre \\
    \hline
    \rule{0pt}{1.5ex}SP, SV ou SUBORDONNÉE & complément du nom & après le nom & le fils [de Marie] \\
    & & & le désir [de partir], l'idée [que tu partes] \\
    \hline
    \rule{0pt}{1.5ex}SP, SV ou SUBORDONNÉE & complément de l'adjectif & après l'adjectif & fier [de lui], fier [de réussir] \\
