...
\begin{table}[H]
    \centering
    % Try reducing font size to make the table fit.
    % Uncomment one of the following lines to test different sizes.
    % \small
    % \footnotesize
    \scriptsize % This is often a good starting point for wide tables

    \begin{adjustbox}{max width=\textwidth}
        \begin{tabular}{| L{5.5cm} | L{2.8cm} | L{6.7cm} |} % Revised column widths
\hline
\textbf{VERBES} & \textbf{INFINITIF} & \textbf{EXEMPLES} \\
\hline
\multicolumn{3}{|c|}{\textbf{À UN COMPLÉMENT}} \\
\hline
...
\hline
\multicolumn{3}{|c|}{\textbf{À DEUX COMPLÉMENTS}} \\
\hline
