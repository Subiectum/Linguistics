...
\begin{table}[H]
    ...
    \hline
    est antérieure & avant (que) & Nous devons rentrer [avant qu'il pleuve]. \\
    \hline
    est postérieure & après (que), dès lors (que), une fois (que), etc. & Il a plu [après qu'on est rentré]. \\
    \hline
    est simultanée & alors (que), aussi longtemps (que), comme, lorsque, pendant (que), quand, tandis que, alors (que), au moment (où), à l'instant (où), à l'époque (où), en même temps (que), etc. & Paul partit [lorsque le jour commença à décliner]. \\
    \hline
    commence ou finit & aussitôt (que), depuis (que), dès (que), d'ici (à ce que), jusqu'à ce que, jusqu'au moment (où), sitôt (que), etc. & Je vais lire ça [dès que j'aurai un peu de temps]. \\
    \hline
    \end{tabular}
