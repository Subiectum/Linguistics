...
\begin{tabular}{|p{3.5cm}|p{3cm}|p{8cm}|} % Adjusted column widths
\hline
\multicolumn{2}{|c|}{\textbf{SENS}} & \textbf{FORMES} \\
\hline
LOCALISATION AVEC OU SANS DÉPLACEMENT & & \textit{à, après, à travers, autour (de), avant, dans, de, derrière, devant, en, le long (de), loin (de), près (de), sous, sur, etc.} \\
\hline
\multirow{3}{*}{\centering LOCALISATION AVEC DÉPLACEMENT} & vers une destination & \textit{direction, en destination (de), en direction (de), jusque, jusqu'à, pour, vers, etc.} \\
\cline{2-3}
& à travers un passage & \textit{par, via, etc.} \\
\cline{2-3}
& depuis une origine & \textit{à partir de, de, depuis, etc.} \\
\hline
\end{tabular}
