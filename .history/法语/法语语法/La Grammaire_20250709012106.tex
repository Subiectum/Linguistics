...
\begin{table}[H]
    \centering
    \small % Optional: reduce font size if the table is still too wide
    ...
    \hline
    à & aller, convenir, correspondre, jouer, manquer, mentir, nuire, obéir, parler, penser, renoncer, ressembler, servir, sourire, suffire, tenir & Cette robe va {à Marie}. \\ % Content will wrap if too wide
