...
\begin{tabular}{|p{3.5cm}|p{3.5cm}|p{7cm}|} % Adjusted column widths for a closer match
\hline
\textbf{SENS} & \multicolumn{1}{c|}{\textbf{}} & \textbf{FORMES} \\ % Empty column header for the middle column
\hline
\multirow{2}{*}{LOCALISATION AVEC OU SANS DÉPLACEMENT} & \multirow{2}{*}{\quad} & \textit{à, après, à travers, autour (de), avant, dans, de, derrière, devant, en, le long (de), loin (de), près (de), sous, sur, etc.} \\
& & \\ % Empty row to create vertical spacing/alignment if needed, though \multirow handles it
\hline
\multirow{6}{3.5cm}{LOCALISATION AVEC DÉPLACEMENT} & \multirow{2}{*}{vers une destination} & \textit{direction, en destination (de), en direction (de), jusque, jusqu'à, pour, vers, etc.} \\
& & \\ % Empty row for spacing/alignment
\cline{2-3} % Partial line across columns 2 and 3
& \multirow{2}{*}{à travers un passage} & \textit{par, via, etc.} \\
& & \\ % Empty row for spacing/alignment
\cline{2-3} % Partial line across columns 2 and 3
& \multirow{2}{*}{depuis une origine} & \textit{à partir de, de, depuis, etc.} \\
& & \\ % Empty row for spacing/alignment
\hline
\end{tabular}
