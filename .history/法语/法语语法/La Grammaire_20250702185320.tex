...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item faire seule avec une expression de manière
        \begin{enumerate}
            ...
            \item \item Marie peint de magnifiques tableaux. J’aimerais faire aussi bien
            \end{itemize}
            
        \end{enumerate}
        \item 与complément nominal \textit{cela, ça, la même chose}连用
        \begin{itemize}
