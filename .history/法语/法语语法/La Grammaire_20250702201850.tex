...
\begin{table}[H]
\centering
\footnotesize % Use \footnotesize for a smaller font size. You can try \scriptsize if needed.

\setlength{\tabcolsep}{2pt} % Reduce column separation to 2pt (default is 6pt)
\renewcommand{\arraystretch}{1.2} % Increase row height for better readability of wrapped text
