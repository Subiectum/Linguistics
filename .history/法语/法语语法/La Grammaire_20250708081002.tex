...
\begin{table}[H]
    \centering
    \begin{tabular}{|>{\RaggedRight}p{6cm}|>{\RaggedRight}p{9cm}|} % 两列，带竖线，自动换行左对齐
        \hline 
        \textbf{VALENCE} & \textbf{EXEMPLES} \\
        \hline 
        \multicolumn{2}{|c|}{\textbf{sans complément :}} \\ % 子标题居中
        \hline
        arriver, survenir & [Qu'il neige en avril] arrive parfois. \\
        \hline 
        \multicolumn{2}{|c|}{\textbf{avec un complément nominal :}} \\
        \hline
        ...
        \hline 
        \multicolumn{2}{|c|}{\textbf{avec un complément prépositionnel :}} \\
        \hline
        ...
        \hline 
        \multicolumn{2}{|c|}{\textbf{avec un complément infinitif ou phrastique :}} \\
        \hline
