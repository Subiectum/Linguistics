...
\begin{table}[H]
    ...
    % The number 659 from the image, placed here for context if desired
    \begin{center}
    659
    \end{center}
    
    \vspace{1cm} % Add some vertical space again
    
    \begin{tabular}{|l|l|l|l|}
    \hline
    \textbf{ÉCRIT} & \textbf{ORAL} & \textbf{EXEMPLES} & \textbf{NOMBRE D'ADJECTIFS} \\
    \hline
    masculin en -\textit{eur} & masculin en /\textvarepsilon r/ & \textit{trompeur / trompeuse, révélateur / révélatrice} & 327 \\
    féminin en -\textit{euse} ou -\textit{rice} & féminin en /\textoe z/ ou /\textices/ & & \\
    \hline
...
\section{Les fonctions syntaxiques de l’adjectif}
\subsection{Ajout}
...
\subsubsection{modifieur de nom et ajout au verbe}

\paragraph{L’adjectif ajout au verbe modifieur de nom sujet}
...
\paragraph{L’adjectif ajout au verbe, modifieur de nom complément}
...
\subsubsection{L’adjectif invariable ajout au verbe ou à la phrase}
\paragraph{L’adjectif invariable modifieur de verbe}
...
\paragraph{L’adjectif invariable connecteur}
...
\subsubsection{L’adjectif attribut du sujet}
...
\subsubsection{L’adjectif attribut du complément}
...
\paragraph{distinguer adjectif attribut du complément et épithète}
\begin{enumerate}
...
\subsubsection{L’adjectif invariable complément de préposition}
\paragraph{En + adjectif}
...
\paragraph{Pour + adjectif/infinitif}
...
\paragraph{En fait de + adjectif/infinitif}
与pour意思相同
\begin{enumerate}
...
\subsubsection{L’adjectif comparatif complément de verbe ou de préposition}
...
\paragraph{À / pour /avec + adjectif comparatif}
该结构中形容词只能为比较级而不是原形
\begin{itemize}
...
\subsection{Extrait et Périphérique}
\subsubsection{extraits}
\paragraph{antéposition avec inversion du sujet }
\begin{enumerate}
...
\paragraph{L’adjectif antéposé dans  comparative corrélative}
\begin{enumerate}
    \item sujet可inversé或pronominal
    \begin{itemize}
...
\paragraph{subordonnée exclamative}





\paragraph{subordonnée concessive}
\begin{enumerate}
