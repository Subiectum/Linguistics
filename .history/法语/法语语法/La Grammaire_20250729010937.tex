...
\subsubsection{Les autres constructions circonstancielles}

\begin{enumerate}
    \item Les ajouts circonstanciels à l’infinitif introduites de prépositions
    \begin{itemize}
    ...
    \end{itemize}
    \item Les ajouts circonstanciels prédicatifs
    \begin{enumerate}
