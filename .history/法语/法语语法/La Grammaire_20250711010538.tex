...
\begin{table}[H]
    ...
    \hline
    \textbf{de perception :} \newline \textit{écouter, entendre, observer, regarder, sentir, voir} & complément \newline oblique & \textit{Luc entend Max [\uline{chanter un air}].} \\
    \hline
    \textbf{d'activité intellectuelle et d'opinion :} \newline \textit{admettre, s’apercevoir, apprendre, calculer, comprendre, constater, contester, croire, découvrir, douter, estimer, évaluer, exclure, ignorer, imaginer, inventer, juger, oublier, penser, savoir, se rappeler, se souvenir (de), supposer, trouver, vérifier} & \multicolumn{1}{L{2.8cm}|}{} % 合并为两列的 VERBES 部分
    & \textit{Je sais [que Paul est rentré].} \newline \textit{Je crois [qu'il va pleuvoir].} \\
    \hline
    \textbf{de communication :} \newline \textit{affirmer, annoncer, avertir, dire, s’écrier, écrire, s’exclamer, expliquer, informer, murmurer, se plaindre (de), prétendre, prévenir, protester, raconter} & \multicolumn{1}{L{2.8cm}|}{} % 合并为两列的 VERBES 部分
