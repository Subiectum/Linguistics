...
\hline
\multirow{3}{*}{\centering date} & antériorité & \textit{avant, jusqu'à, d'ici, \% endéans} & \textit{avant le dîner, d'ici la fin du mois, \% endéans la fin du mois} \\
\cline{2-4}
...
\hline
\multirow{3}{*}{\centering durée} & antériorité & \textit{il y a, voici, voilà} & \textit{il y a un mois, voici trois ans} \\
\cline{2-4}
