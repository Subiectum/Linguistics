...
\begin{enumerate}
    ...
    \begin{table}[H]
        ...
        \hline
        + \textit{est-ce que}, \textit{qui est-ce que}, \textit{qu'est-ce que} & \textcolor{blue}{\% J'ai entendu [\textit{où est-ce qu'il est allé}]}. \\
        & ! Je me demande [\textit{qu'est-ce qu'il cherche}]. \\
        \hline
        + \textit{c'est que} / \textit{qui} & \textcolor{blue}{\% Je me demande [\textit{où c'est qu'il est allé}]}. \\
