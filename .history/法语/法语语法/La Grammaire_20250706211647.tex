...
\begin{table}[H]
    ...
    \hline
    déclarative & \textit{que, de ce que} & indicatif ou subjonctif & \RaggedRight SUJET, COMPLÉMENT DIRECT ou OBLIQUE \\
    \hline
    désidérative & \textit{que, à de que} & subjonctif & \RaggedRight SUJET, COMPLÉMENT DIRECT ou OBLIQUE \\
    \hline
    interrogative & \textit{si}, mot, syntagme interrogatif & indicatif & \RaggedRight SUJET, COMPLÉMENT DIRECT ou OBLIQUE \\
    \hline
    exclamative & mot, syntagme exclamatif, \textit{que} & indicatif ou subjonctif & \RaggedRight SUJET, COMPLÉMENT DIRECT ou OBLIQUE \\
    \hline
    \end{tabular}
\end{table}
