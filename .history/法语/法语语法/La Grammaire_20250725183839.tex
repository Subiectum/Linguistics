...
\begin{table}[H]
    ...
    \hline
    extrait & \textit{auquel, duquel, où, prép} + \textit{lequel} & \textit{l'homme [auquel je parle]} \\
    correspondant à un complément & \textit{prép} + \textit{où} & \textit{l'homme [à qui je parle]} \\
    & \textit{prép} + \textit{qui, prép} + \textit{quoi} & \textit{l'endroit [où je vais]} \\
    ...
    & \textit{prép} + \textit{qui, prép} + \textit{quoi,} & \textit{Luc est parti, ce [pourquoi tout va mal].} \\
