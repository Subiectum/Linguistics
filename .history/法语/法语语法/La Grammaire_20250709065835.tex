...
\begin{enumerate}
    ...
    \hline
    \textbf{d'accompagnement :} \newline \textit{accompagner, escorter} & \textit{Le colis est accompagné [\uline{d'un mode d'emploi}].} \\
    \hline
    \textbf{d'assistance :} \newline \textit{aider, appuyer, assister, seconder} & \textit{Le directeur est aidé [\uline{d'un assistant}].} \\
    \hline
    \textbf{donnant la composition d'un groupe :} \newline \textit{composer, constituer, former} & \textit{Le gouvernement est constitué [\uline{de quinze ministres}].} \\
    \hline
    \textbf{instrumentaux :} \newline \textit{entourer, recouvrir} & \textit{Le jardin est recouvert [\uline{de feuilles}].} \\
    \hline
    \textbf{de localisation :} \newline \textit{précéder, suivre} & \textit{Le diner sera suivi [\uline{d'un concert}].} \\
    \hline
    \textbf{d'opinion ou d'activité intellectuelle :} \newline \textit{admettre, approuver, comprendre, connaître, rejeter, tolérer} & \textit{La situation n'a pas été comprise [\uline{de la population}].} \\
    \hline
    \textbf{de perception :} \newline \textit{écouter, entendre, voir} & \textit{Son cri a été entendu [\uline{de tous}].} \\
    \hline
    \textbf{de sentiment :} \newline \textit{aimer, apprécier, craindre, détester, envier, inquiéter, mépriser, surprendre} & \textit{Ce livre est apprécié [\uline{de tous}].} \newline \textit{Je suis étonné [\uline{du départ de Max}].} \\
    \hline
    \end{tabular}
\end{table}
    \end{enumerate}
