...
\subsection{La distinction faible et forte}
\begin{enumerate}
    \item 弱形式不能单独使用
    \begin{itemize}
...
\begin{enumerate}
    \item 可作主语，但不能作为compléments directs或introduits par \emph{à} datif (sauf modification ou coordination)
    \begin{itemize}
