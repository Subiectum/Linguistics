...
\begin{table}[H]
    ...
    \hline
    interrogative & si, mot, syntagme interrogatif & indicatif & \RaggedRight SUJET, COMPLÉMENT DIRECT ou OBLIQUE \\
    \hline
    exclamative & mot, syntagme exclamatif, que & indicatif ou subjonctif & \RaggedRight SUJET, COMPLÉMENT DIRECT ou OBLIQUE \\
    \hline
    \end{tabular}
\end{table}
