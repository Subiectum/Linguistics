...
\begin{table}[H]
    ...
    % Define column types for easier use, especially for X columns
    % X_L: X column with ragged right (left aligned)
    \newcolumntype{X_L}{>{\RaggedRight\arraybackslash}X}

    \begin{tabularx}{\textwidth}{|l|X_L|X_L|} % Use X_L for content columns
    \hline
