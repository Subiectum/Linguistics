...
\begin{table}[H]
    ...
    \renewcommand{\arraystretch}{1.0} % Reset arraystretch to default or adjust as needed
                                      % as the main issue was using separate rows for examples
    ...
    \hline
    % All examples for 'à' are now in a single cell, separated by a space or \newline
    à & aller, convenir, correspondre, jouer, manquer, mentir, nuire, obéir, parler, penser, renoncer, ressembler, servir, sourire, suffire, tenir
    & Cette robe va {à Marie}. Paul ressemble {à son frère}. Cette pièce sert {à mon frère}. \\
    \hline
    après & s'acharner, \%, chercher, courir, \%, demander, passer, pleurer, venir
    & Les parents passent {après les enfants}. Léa court {après la renommée}. \\
    \hline
    avec & discuter, négocier, parler, permuter, rimer
    & Paul parle {avec Marie}. Paul négocie {avec Marie}. \\
    \hline
    contre, pour & échanger, opter, parier, se prononcer, voter
    & Paul opte {pour votre proposition}. Paul vote {contre votre proposition}. \\
    \hline
    de & convenir, différer, discuter, douter, jouer, manquer, parler, remplir, rêver, rire, servir, tenir, traiter, se vanter, vider
    & Paul parle {de son travail}. Paul manque {de place}. Cette pièce sert {de débarras}. \\
    \hline
    en & consister, dégénérer, finir, muer, partir
    & Ce logement consiste {en deux pièces}. Le jeu dégénère {en pugilat}. \\
    \hline
    par & commencer, débuter, finir, terminer
    & Le spectacle commence {par un concert}. \\
    \hline
    sur & s'accorder, s'acharner, agir, anticiper, s'appuyer, compter, cracher, crier, discourir, s'entendre, foncer, hurler, interroger, insister, marcher, médire, mentir, parler, passer, pleurer, taper, tirer, régner, se reposer, revenir, sauter, tomber
    & Paul compte {sur son frère}. Paul insiste {sur sa proposition}. Paul tire {sur un pigeon}. Luc saute {sur l'occasion}. \\
    \hline
    autres prépositions & choisir (entre), se comporter, se conduire, durer, hésiter (entre), passer (avant), se plaindre (auprès de), se porter, ressusciter (d'entre)
    & Luc hésite {entre ces meubles}. Max se conduit {avec tact}. La garantie dure {jusqu'en 2020}. \\
    \hline
    \end{tabularx}
\end{table}
