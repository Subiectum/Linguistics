...
\begin{table}[H]
    ...
    \begin{tabular}{|>{\raggedright\arraybackslash}p{0.3\textwidth}|>{\raggedright\arraybackslash}p{0.3\textwidth}|}
        \hline
        \rowcolor[HTML]{DDEBF7} % Light blue for header
        \textbf{VERBE SANS COMPLÉMENT PROPRE} & \textbf{VERBE AVEC COMPLÉMENT PROPRE} \\
        \hline
        \multicolumn{2}{|c|}{\cellcolor[HTML]{DDEBF7}\textbf{SUJET PRÉDICATIF}} \\ % Merged header row
        \hline
        ...
        \hline
        \multicolumn{2}{|c|}{\cellcolor[HTML]{DDEBF7}\textbf{COMPLÉMENT DIRECT PRÉDICATIF}} \\ % Merged header row
        \hline
        ...
        \hline
        \multicolumn{2}{|c|}{\cellcolor[HTML]{DDEBF7}\textbf{COMPLÉMENT OBLIQUE PRÉDICATIF}} \\ % Merged header row
        \hline
