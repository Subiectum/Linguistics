...
\cline{2-9}
\multicolumn{1}{|c|}{} & \textbf{Present} & \textbf{Simple past} [\textbf{PAST}] & \textbf{Imperfect} [\textbf{1P}] & \textbf{Future} [\textbf{FUT}] & \textbf{Present} & \textbf{Imperfect} [\textbf{PAST}] & \textbf{Present} & \textbf{Present} \\
\hline
\textbf{je} & \textbf{1S}+e/s/x & +ai/s & +ais & +ai & \textbf{3P/SUBJ}+e &  +()sse & \textbf{FUT}+rais & \\
\hline % Full line after je row
\textbf{tu} & \textbf{1S}+es/s/x & +a(s) & +ais & +as & \textbf{3P/SUBJ}+es & +()sses & \textbf{FUT}+rais & \textbf{1S}+s/t \textbf{SUBJ}+e\\
\hline
\textbf{il/elle} & \textbf{1S}+e/t/- & +a/t & +ait & +ra & \textbf{3P/SUBJ}+e & +(\^{})t & \textbf{FUT}+rait & \\
\hline
\textbf{nous} & \textbf{1P}+ons & + (\^{})mes & +ions & +rons & \textbf{1P/SUBJ} +ions& + ()ssions & \textbf{FUT}+rions & \textbf{1P}+ons  \textit{or} \textbf{SUBJ}+ons \\

\hline
\textbf{vous} & \textbf{1P}+ez & + (\^{})tes & +iez & +rez & \textbf{1P/SUBJ} +iez & + ()ssiez & \textbf{FUT}+riez & \textbf{1P}+ez  \textit{or} \textbf{SUBJ}+ez \\

\hline
\textbf{ils/elles} & \textbf{3P}+ent & + (\^{})rent & +aient & +ront & \textbf{3P/SUBJ}+ ent & + ()ssent & \textbf{FUT}+raient & \\
\hline
\end{tabularx}
\end{table}
