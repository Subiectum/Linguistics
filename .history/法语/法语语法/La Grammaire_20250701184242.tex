...
\textbf{tu} & \textbf{1S}+es/s/x & \textbf{PAST}+s & \textbf{1P}+ais & \textbf{FUT}+as & \textbf{SUBJ}+es & \textbf{PAST}+sses & \textbf{FUT}+ais & \textbf{1S}+s/t \\
& & & & & & & & \textbf{SUBJ}+e \\
\hline
\textbf{il/elle} & \textbf{1S}+e/t/- & \textbf{PAST}+t & \textbf{1P}+ait & \textbf{FUT}+a & \textbf{SUBJ}+e & \textbf{PAST}+t & \textbf{FUT}+ait & \\
\hline
...
\hline
\textbf{vous} & \textbf{1P}+ez & \textbf{PAST}+tes & \textbf{1P}+iez & \textbf{FUT}+ez & \textbf{SUBJ}+iez & \textbf{PAST}+ssiez & \textbf{FUT}+iez & \textbf{1P}/\textbf{SUBJ}+ez \\
