...
\hline
\textbf{je} & \textbf{1S}+es/s/x & \textbf{PAST}+ai/s &\textbf{1P}+ais & \textbf{FUT}+ai & \textbf{SUBJ}+e & \textbf{PAST}+sse & \textbf{FUT}+ais & \\
\hline % Full line after je row
\textbf{tu} & \textbf{1S}+es/s/x & \textbf{PAST}+a(s) & \textbf{1P}+ais & \textbf{FUT}+as & \textbf{SUBJ}+es & \textbf{PAST}+sses & \textbf{FUT}+ais & \textbf{1S}+s/t \\
& & & & & & & & \textbf{SUBJ}+e \\
\hline
\textbf{il/elle} & \textbf{1S}+e/t/- & \textbf{PAST}+a/t & \textbf{1P}+ait & \textbf{FUT}+ra & \textbf{SUBJ}+e & \textbf{PAST}+t & \textbf{FUT}+ait & \\
\hline
\textbf{nous} & \textbf{1P}+ons & \textbf{PAST}+(^)mes & \textbf{1P}+ions & \textbf{FUT}+rons & \textbf{SUBJ}+ions & \textbf{PAST}+ssions & \textbf{FUT}+ions & \textbf{1P}/\textbf{SUBJ}+ons \\
& & & & & \textit{or} \textbf{1P}+ions & & & \\
\hline
\textbf{vous} & \textbf{1P}+ez & \textbf{PAST}+()tes & \textbf{1P}+iez & \textbf{FUT}+rez & \textbf{SUBJ}+iez & \textbf{PAST}+ssiez & \textbf{FUT}+iez & \textbf{1P}/\textbf{SUBJ}+ez \\
& & & & & \textit{or} \textbf{1P}+iez & & &  \\
\hline
\textbf{ils/elles} & \textbf{3P}+ent & \textbf{PAST}+()rent & \textbf{1P}+aient & \textbf{FUT}+ront & \textbf{SUBJ}+ent & \textbf{PAST}+ssent & \textbf{FUT}+aient & \\
\hline
\end{tabularx}
\end{table}
