...
\begin{enumerate}
    ...
    \end{itemize}
    \item de quoi : dénote une quantité et indique le moyen de l’action. 其主句动词总表示avoir à sa disposition ou faire que quelqu’un ait à sa disposition : avoir, chercher, donner, gagner, laisser, trouver
    \begin{enumerate}
        \begin{itemize}
