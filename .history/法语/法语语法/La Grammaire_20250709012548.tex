...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|>{\raggedright}l|X|X|} % X columns allow automatic text wrapping
    \hline
    \textbf{PRÉPOSITIONS} & \textbf{VERBES} & \textbf{EXEMPLES} \\
    \hline
    à & aller, convenir, correspondre, jouer, manquer, mentir, nuire, obéir, parler, penser, renoncer, ressembler, servir, sourire, suffire, tenir % Text will wrap here if it's too long for the column width
    & Cette robe va {à Marie}. \\ % Text will wrap here too
    ...
    \hline
    autres prépositions & choisir (entre), se comporter, se conduire, durer, hésiter (entre), passer (avant), se plaindre (auprès de), se porter, ressusciter (d'entre) & Luc hésite {entre ces meubles}. \\Max se conduit {avec tact}. 
