...
\begin{table}[H] % [H] to place the table exactly here
    ...
    % Table 1 content (from 01.16.44.jpg) - using booktabs style
    \begin{tabularx}{\textwidth}{l Y Y}
        ...
        \bottomrule % Bottom horizontal line for the first section
    \end{tabularx}
\end{table}

% Use \clearpage to ensure the next table starts on a new page, if it doesn't fit on the current one
\clearpage
...
\begin{table}[H] % [H] to place the table exactly here
    ...
    % Table 2 content (from 03.02.21.jpg) - this one has vertical lines
