...
\begin{table}[H]
    ...
    \hline
    adverbe + que & aussitôt, alors, aussi longtemps, dès lors, maintenant, sitôt, etc. & Il est parti [aussitôt qu'on lui a demandé]. \\
    & & Il est heureux [maintenant qu'il a fini]. \\
    \hline
    préposition + que & après, avant, depuis, dès, en attendant, pendant, une fois & On ne l'a pas vu [depuis qu'il a terminé]. \\
    \hline
    préposition + à ce que & d'ici, jusque & [D'ici à ce qu'il s'énerve], il n'y a qu'un pas. \\
    \hline
    subordonnant & comme, lorsque, quand, tandis que, tant que & [Quand je suis parti], il faisait beau. \\
    & & Que faire [lorsqu'on ne dort plus] ? \\
    \hline
    syntagme nominal + que & aujourd'hui, chaque fois & Que faire [chaque fois qu'on a fini] ? \\
    \hline
    syntagme prépositionnel + que & \% au moment, en même temps, d'ici & Il travaille [en même temps qu'il étudie]. 
    \newline [D'ici qu'il pleuve], on a le temps de sortir. \\
    \hline
    syntagme prépositionnel + où & au moment, à l'instant, à l'époque, jusqu'au moment, etc. & Il est arrivé [au moment où je partais]. \\
    \hline
