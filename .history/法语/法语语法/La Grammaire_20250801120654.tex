...
\begin{enumerate}
    ...
    \begin{itemize}
        \item aul n’a pas travaillé [autant qu’on lui avait demandé].
    \end{itemize}
...
\begin{enumerate}
    \item comparative在动词后与syntagme comportant l’adverbe comparatif 分隔开
    \begin{itemize}
    ...
    \end{itemize}
    \item syntagme comportant l’adverbe comparatif作为主句时，comparative亦可与其分隔开
    \begin{itemize}
...
\begin{enumerate}
    \item ajout à un adjectif，从句使用être，可加也可不加所修饰的形容词，或者用le指代
    \begin{itemize}
