...
\begin{enumerate}
    \item Une subordonnée relative peut être séparée de son antécédent nominal (nom, pronom, syntagme nominal)
        \begin{itemize}
            \item [Le temps] n’est plus où les avocats tiraient leur renommée des cours d’assises. 
            \item [Trois étapes] sont prévues au terme desquelles l’économie russe va retrouver un rythme de croissance positif
            \item [Les auteurs] l’ont bien compris qui jouent résolument la carte des plats de jadis présentés à la manière d’antan.
        \end{itemize}
    \item quel ou combien后可跟relative ajout，也可跟relative extraposée
    \begin{itemize}
        \item [Quelle solution] qui te parait intéressante a-t-on proposée ?
        \item [Quelle solution] a-t-on proposée qui te parait intéressante ?
        \item [Combien d’expériences] n’ont pas donné de résultats qui paraissaient prometteuses ?
    \end{itemize}
    \item qui和que后不能跟relative ajout，但其可作relative extraposée的先行词
    \begin{itemize}
        \item * Qui que tu ne connaissais pas déjà as-tu rencontré ?
        \item [Qui] as-tu rencontré que tu ne connaissais pas déjà ?
        \item Avec [qui] avez-vous parlé que vous ne connaissiez pas déjà ?
        \item [Qui] n’a pas pu venir à la réunion, qui n’était pas prêt ?
    \end{itemize}
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item [Des dispositions complémentaires] se révèleront donc nécessaires, comme on peut le voir dès aujourd’hui, qui empêcheront les attitudes individualistes des états membres.
        \item [Une femme] est arrivée alors que l’on n’attendait plus personne, qui portait elle aussi un grand chapeau noir.
    \end{itemize}
    \item relative extraposée可有多个先行词，因此从句动词用复数
    \begin{itemize}
        \item [Une femme] est arrivée, et [un homme] s’est installé au bar, qui avaient l’air de se connaitre.
        \item Paul aime [les croissants], mais Marie préfère [les pâtisseries danoises], qu’ils dégustent avec leur thé de l’après-midi.
    \end{itemize}
