...
\small
\begin{longtable}{|m{4cm}|m{6cm}|m{5cm}|}
\hline
...
\hline
avantage & au profit (de), au bénéfice (de), en faveur (de), pour. & \textit{un modèle [pour chiens]} \textit{des mesures [en faveur des réfugiés]} \\
\hline
...
& & \textit{de la haine [envers quelqu'un]} \\
& & \textit{travailler [pour le plaisir]} \\
\hline
...
& & \textit{rouge [de colère]} \\
& & \textit{une branche cassée [par le vent]} \\
\hline
...
& & \textit{partir [malgré la chaleur]} \\
\hline
...
& & \textit{un modèle [pour 20 euros]} \\
& & \textit{un sac [de 20 kilos]} \\
& & \textit{trois [fois trois]} \\
\hline
