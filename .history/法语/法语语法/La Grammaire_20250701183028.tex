...
\hline
\textbf{je} & & \multicolumn{1}{|l|}{} & \multicolumn{1}{|l|}{} & \textbf{FUT}+ai & \textbf{SUBJ}+e & \textbf{PAST}+sse & & \\
...
\hline
\textbf{nous} & \textbf{1P}+ons & \textbf{PAST}+^tmes & \textbf{1P}+ions & \textbf{FUT}+ons & \textbf{SUBJ}+ions & \textbf{PAST}+ssions & \textbf{FUT}+ions & \textbf{1P}+ons \textit{or} \\
& & & & & \textit{or} \textbf{1P}+ions & & & \textbf{SUBJ}+ons \\
\hline
\textbf{vous} & \textbf{1P}+ez & \textbf{PAST}+^ttes & \textbf{1P}+iez & \textbf{FUT}+ez & \textbf{SUBJ}+iez & \textbf{PAST}+ssiez & \textbf{FUT}+iez & \textbf{1P}+ez \textit{or} \\
