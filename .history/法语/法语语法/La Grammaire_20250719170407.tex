...
avec, dès, sans : un syntagme nominal + un complément prédicatif. complément nominal可解释为le sujet du complément prédicatif，可在其前也可在其后
\begin{enumerate}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{|>{\raggedright\arraybackslash}p{0.15\textwidth}|>{\raggedright\arraybackslash}p{0.4\textwidth}|>{\raggedright\arraybackslash}p{0.4\textwidth}|}
        ...
        \hline
        simples & à, afin (de), après, avant (de), contre, de, faute (de), histoire (de), loin (de), pour, quant (à), quitte (à), sans & afin (que), après (que), attendu (que), avant (que), depuis (que), dès (que), faute (que), histoire (que), moyennant (que), outre (que), pendant (que), pour (que), pourvu (que), sans (que), selon (que), suivant (que), vu (que) \\
        \hline
        complexes & à condition (de), à force (de), au lieu (de), à moins (de), au point (de), de / par crainte (de), de / par peur (de), de manière (à), de façon (à), de là (à), d'ici (à), en sus (de) & à condition (que), à force (que), au fur et à mesure (que), au lieu (que), à moins (que), au point (que), compte tenu (de / de ce que), de / par crainte (de), de façon (à ce que), d'ici (à ce que), de là à ce que), de manière (à ce que), de sorte (que), du moment (que), étant donné (que), de / par peur (que) \\
        \hline
    \end{tabular}
    \caption{Les prépositions à complément infinitif ou avec subordonnée}
\end{table}
