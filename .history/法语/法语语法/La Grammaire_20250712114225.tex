...
\centering
\small
\begin{tabularx}{0.8\textwidth}{|p{2.5cm}|p{3cm}|X|X|}
\hline
\textbf{INTERROGATIVE} & \textbf{SI} & \textbf{MOT ou SYNTAGME INTERROGATIF} & \textbf{SANS VERBE} \\
\hline
totale &
...
partielle &
--- &
\emph{Je demande [qui viendra].} \newline
\emph{Je demande [qui mange quoi].} &
\emph{Je demande [comment].} \\
\hline
alternative &
\emph{Je demande [si Luc vient ou non].} \newline
\emph{Je demande [si Léa va à Aix ou à Nice].} &
--- &
--- \\
\hline
\end{tabularx}
...
\begin{enumerate}
    \item Les subordonnées interrogatives partielles
    \begin{enumerate}
