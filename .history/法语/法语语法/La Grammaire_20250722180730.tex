...
\begin{table}[H]
    ...
    \begin{longtable}{|m{7cm}|m{8cm}|}
    \hline
    \rowcolor[HTML]{EBF2F7} % Light blue background for the header row
    \textbf{SUBORDONNÉE} & \textbf{EXEMPLES} \\
    \hline
    \endfirsthead
    \hline
    \rowcolor[HTML]{EBF2F7}
    \textbf{SUBORDONNÉE} & \textbf{EXEMPLES} \\
    \hline
    \endhead
    \hline
...
注意不要把subordonnées complétive与ce引导的subordonnée relative弄混
\begin{enumerate}
