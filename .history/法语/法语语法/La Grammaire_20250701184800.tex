...
\hline
\textbf{je} & \textbf{1S}+es/s/x & \textbf{PAST}+ai/s & & \textbf{FUT}+ai & \textbf{SUBJ}+e & \textbf{PAST}+sse & \textbf{FUT}+ais & \\
\hline % Full line after je row
\textbf{tu} & \textbf{1S}+es/s/x & \textbf{PAST}+ai/s & \textbf{1P}+ais & \textbf{FUT}+as & \textbf{SUBJ}+es & \textbf{PAST}+sses & \textbf{FUT}+ais & \textbf{1S}+s/t \\
& & & & & & & & \textbf{SUBJ}+e \\
\hline
\textbf{il/elle} & \textbf{1S}+e/t/- & \textbf{PAST}+t & \textbf{1P}+ait & \textbf{FUT}+ra & \textbf{SUBJ}+e & \textbf{PAST}+t & \textbf{FUT}+ait & \\
\hline
