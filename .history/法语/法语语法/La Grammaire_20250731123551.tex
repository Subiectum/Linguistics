...
\begin{table}[H]
    ...
    \begin{adjustbox}{max width =\textwidth}
        ...
        \textbf{INTRODUCTEUR} & \textbf{FORMES} & \textbf{EXEMPLES} \\
        \hline
        adverbe + que & alors, alors même, encore & Il est sorti [alors que nous l'avions interdit]. \\
        \hline
        préposition + que & pendant, sans & Il a bon cœur [sans que cela se voie]. \\
        \hline
        proforme + que & quel, quoi, où, etc. & [Quoi qu'ils aient fait], ils ont bien fait. \\
        \hline
        subordonnant & bien que, lorsque, même si, quand, quand bien même, quoique, si, tandis que & Personne ne l'envie [bien qu'il soit riche]. \\
        \hline
        Syntagme antéposé + que & aussi, si, quelque, tout + adjectif, adverbe, nom ou préposition & [Aussi prudent qu'il soit], il ne peut tout prévoir. \\
