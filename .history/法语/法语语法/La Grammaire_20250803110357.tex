...
\begin{table}[H]
    ...
    \textbf{CATÉGORIE} & \textbf{FONCTION} & \textbf{POSITION} & \textbf{EXEMPLES} \\
    \hline
    \rule{0pt}{1.5ex}ADJECTIF, ADVERBE, DÉTERMINANT, NOM & spécifieur du nom & début de syntagme & [le] médecin, [mon] ami, [pareille] aventure, [beaucoup] de bruit, [nombre] de difficultés \\
    \hline
