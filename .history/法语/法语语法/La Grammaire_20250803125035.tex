...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \end{itemize}
        \item dans une interrogative introduite par l’adverbe \textit{que} (pourqoi) avec un ne négatif et qui exprime un regret, 必须用sujet suffixé. Un sujet préverbal ne serait pas possible
        \begin{itemize}
