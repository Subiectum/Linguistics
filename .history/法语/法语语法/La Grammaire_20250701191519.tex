...
\hline
\textbf{je} & \textbf{1S}+e/s/x & +ai/( )s & +ais & +rai & \textbf{3P/SUBJ}+e &  +( )sse & +rais & \\
\hline % Full line after je row
\textbf{tu} & \textbf{1S}+es/s/x & +(a)s & +ais & +ras & \textbf{3P/SUBJ}+es & +( )sses & +rais & \textbf{1S}+s/t \textbf{SUBJ}+e\\
\hline
\textbf{il/elle} & \textbf{1S}+e/t/- & +a/t & +ait & +ra & \textbf{3P/SUBJ}+e & +(\^{})t & +rait & \\
\hline
\textbf{nous} & \textbf{1P}+ons & + (\^{})mes & +ions & +rons & \textbf{1P/SUBJ} +ions& + ( )ssions & +rions & \textbf{1P/SUBJ} +ons \\

\hline
\textbf{vous} & \textbf{1P}+ez & + (\^{})tes & +iez & +rez & \textbf{1P/SUBJ} +iez & + ( )ssiez & +riez & \textbf{1P/SUBJ} +ez \\
