...
\hline
auditive & \textit{ENTENDRE} \newline \textit{ouïr} & \textit{ÉCOUTER} \\
\hline
gustative & \% \textit{gouter} \newline \textit{SENTIR} & \textit{déguster, savourer} \newline \textit{GOÛTER} \\
\hline
olfactive & \textit{SENTIR} & \textit{SENTIR} \newline \textit{flairer, humer, renifler} \\
\hline
tactile & \textit{ressentir} \newline \textit{SENTIR} & \textit{palper, tâter, toucher} \newline \textit{SENTIR} \\
\hline
visuelle & \textit{VOIR} \newline \textit{apercevoir, entrevoir, observer} & \textit{REGARDER} \newline \textit{contempler, fixer, guetter, lorgner, mirer, scruter, visionner} \\
\hline
non restreinte & \textit{PERCEVOIR} \newline \textit{déceler, discerner, noter, remarquer} & \quad --- \\
\hline
\end{tabular}
