...
\begin{table}[H]
    \centering
    \begin{tabular}{|p{2.5cm}|p{3.5cm}|p{2.5cm}|p{3cm}|p{5cm}|}
    \hline
    \textbf{TYPE DE PHRASE} & \textbf{INTRODUCTEUR} & \textbf{MODE} & \textbf{FONCTION} & \textbf{EXEMPLES} \\
    \hline
    déclarative & que, de ce que & indicatif ou subjonctif & \RaggedRight SUJET, COMPLÉMENT DIRECT ou OBLIQUE & \RaggedRight [Que Paul vienne] me déplaît. Je sais [que vous viendrez]. Je me souviens [qu'il est venu]. \\
    \hline
    désidérative & que, à de que & subjonctif & \RaggedRight SUJET, COMPLÉMENT DIRECT ou OBLIQUE & \RaggedRight [Qu'il parte] est préférable. Je veux [qu'il parte]. Paul tient [à ce que tout soit prêt]. \\
    \hline
    interrogative & si, mot ou syntagme interrogatif & indicatif & \RaggedRight SUJET, COMPLÉMENT DIRECT ou OBLIQUE & \RaggedRight \% [Si cela compte] n'est pas clair. J'ignore [qui sera là]. Ça dépend [si elle vient]. \\
    \hline
    exclamative & mot ou syntagme exclamatif ou que & indicatif ou subjonctif & \RaggedRight SUJET, COMPLÉMENT DIRECT ou OBLIQUE & \RaggedRight [Qu'il ait tant souffert] m'étonne. Je sais [qu'il a tant souffert]. Je regrette [qu'il ait tant souffert]. Je me souviens [comme il a souffert]. \\
    \hline
    \end{tabular}
\end{table}
