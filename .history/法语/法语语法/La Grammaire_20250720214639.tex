...
d'ici, en proie, grâce, jusque, par rapport, quant, suite & \textit{en proie [à l'angoisse]}, \textit{grâce [à vous]}, \textit{jusqu'[à midi]}, \textit{quant [à moi]}, \textit{suite [à votre rapport]}, \textit{d'ici [à Noël]} \\
\hline
introduit par \textbf{de} : & \\
à cause, à compter, à côté, à force, à longueur, à l'aide, à l'insu, à moins, à partir, \% au fur, au fur et à mesure, auprès, autour, au bout, au-dessus, au-dessous, au lieu, au moyen, de la part, en bas, en dehors, en dépit, en face, en guise, en haut, en raison, faute, hors, loin, près, vis-à-vis & \textit{auprès [de vous]}, \textit{à cause [de vous]}, \textit{en face [de la maison]}, \textit{faute [de place]}, \textit{hors [de ma vue]}, \textit{vis-à-vis [de vous]} \\
\hline
introduit par une autre préposition : & \\
comme, de, depuis, derrière, devant, jusque, par, vers & \textit{comme [chez vous]}, \textit{depuis [avant la guerre]}, \textit{devant [chez vous]}, \textit{jusque [dans trois jours]}, \textit{vers [chez Marie]} \\
\hline
\end{longtable}
...
\begin{table}[H]
    ...
    infinitif : & \\
    à, après, contre, de, entre, pour, sans & \textit{après [être parti]}, \textit{pour [bien réussir]}, \textit{sans [mentir]} \\
    \hline
    infinitif introduit par \textbf{à} : & \\
    de façon, de là, d'ici, de manière, quant, quitte & \textit{de là [à mentir]}, \textit{de manière [à réussir]}, \textit{quant [à partir]}, \textit{quitte [à échouer]} \\
    \hline
    infinitif introduit par \textbf{de} : & \\
    afin, à condition, à force, à moins, au lieu, au point, de peur, en dehors, en train, faute, histoire, loin, par crainte, sur le point & \textit{afin [de réussir]}, \textit{à force [de travailler]}, \textit{loin [de mentir]}, \textit{faute [de réussir]} \\
    \hline
    \end{longtable}
...
en que (indicatif) : & \\
\% à cause, à mesure, à moins, au lieu, après, à part, au point, attendu, au fur et à mesure, compte tenu, d'autant, dès, depuis, de même, du fait, du moment, étant donné, excepté, \% genre, hormis, \% moyennant, outre, pendant, sauf, selon, suivant, une fois, vu & \textit{attendu [que tu es parti]}, \textit{depuis [que tu es parti]}, \textit{dès [que tu pourras]}, \textit{pendant [que tu lis]}, \textit{sauf [qu'il était trop tard]}, \textit{selon [que tu viendras ou non]} \\
\hline
en que (subjonctif) : & \\
afin, \% après, avant, à condition, à moins, au point, de, par crainte, de (par peur, de (telle) sorte, en sorte, excepté, \% faute, histoire, hormis, pour, pour peu, pourvu, sans, sauf & \textit{à condition [que tu viennes]}, \textit{afin [que tu viennes]}, \textit{avant [que tu partes]}, \textit{à moins [que tu viennes]}, \textit{histoire [que tu saches]}, \textit{pour [que tu saches]}, \textit{sans [que ce soit prévu]} \\
\hline
en ce que : & \\
en, jusqu'à & \textit{en [ce que rien n'a été fait]}, \textit{jusqu'à [ce que tu viennes]} \\
\hline
en à ce que : & \\
de façon, d'ici, de là, de manière, quitte, sauf & \textit{de façon [à ce que tout soit prêt]}, \textit{d'ici [à ce qu'on l'engage]}, \textit{quitte [à ce qu'on vienne]}, \textit{sauf [à ce qu'il pleuve]} \\
\hline
en de ce que : & \\
à cause & \textit{\% à cause [de ce qu'il pleuvait]} \\
\hline
autre : & \\
à, de, excepté, hormis, sauf, selon & \textit{excepté [quand il pleut]}, \textit{sauf [si tu viens]} \\
\hline
\end{longtable}
