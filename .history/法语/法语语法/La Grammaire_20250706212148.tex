...
\begin{table}[htbp]
  ...
  \begin{tabular}{
    >{\raggedright\arraybackslash}p{2.5cm}  % 首列左对齐
    >{\itshape}p{3.5cm}                     % 斜体引语列
    p{2.5cm}
    >{\raggedright\arraybackslash}p{4.5cm}   % 功能列左对齐
  }
  \toprule
  \rowcolor{cyan!15}  % 更柔和的表头颜色
  ...
  & Sujet, complément direct/oblique \\
  
  \addlinespace[4pt]  % 增加行间距
