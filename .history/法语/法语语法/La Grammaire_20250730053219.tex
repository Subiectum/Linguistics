...
\begin{enumerate}
    \item d’autant, maintenant, non, surtout + que ; d’autant + comparatif (d’autant moins, d’autant plus) + que
    \begin{itemize}
    ...
    \end{itemize}
    \item dès lors + que ; 其与que间可被其他修饰成分分开
    \begin{itemize}
