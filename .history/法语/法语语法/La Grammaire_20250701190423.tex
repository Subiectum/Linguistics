...
\hline
\textbf{nous} & \textbf{1P}+ons & \textbf{PAST}+ (\^{})mes & \textbf{1P}+ions & \textbf{FUT}+rons & \textbf{SUBJ}+ions & \textbf{PAST}+ ()ssions & \textbf{FUT}+rions & \textbf{1P}+ons \textit{or} \textbf{SUBJ}+ons \\
& & & & & \textit{or} \textbf{1P}+ions & & &  \\
\hline
