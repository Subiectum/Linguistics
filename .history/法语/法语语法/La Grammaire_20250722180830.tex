...
\begin{table}[H]
    ...
    \begin{longtable}{|m{7cm}|m{8cm}|}
    \hline
    \rowcolor{cyan!20} % Light blue background for the header row
    \textbf{SUBORDONNÉE} & \textbf{EXEMPLES} \\
    \hline
    \endfirsthead
    \hline
    ...
    \multicolumn{2}{|c|}{\cellcolor{cyan!10}}\textbf{COMPLÉMENT DIRECT}} \\ 
    \hline
    ...
    \hline
    \multicolumn{2}{|c|}{\cellcolor{cyan!10}\textbf{COMPLÉMENT OBLIQUE}} \\ 
    \hline
