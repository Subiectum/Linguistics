...
\begin{table}[H]
    ...
    \hline
    \textbf{TYPE DE PHRASE} & \textbf{INTRODUCTEUR} & \textbf{MODE} & \textbf{FONCTION} \\
    \hline
    déclarative & que, de ce que & indicatif ou subjonctif & \RaggedRight SUJET, COMPLÉMENT DIRECT ou OBLIQUE \\
    \hline
    désidérative & que, à de que & subjonctif & \RaggedRight SUJET, COMPLÉMENT DIRECT ou OBLIQUE \\
    \hline
    interrogative & si, mot ou syntagme interrogatif & indicatif & \RaggedRight SUJET, COMPLÉMENT DIRECT ou OBLIQUE \\
    \hline
    exclamative & mot ou syntagme exclamatif ou que & indicatif ou subjonctif & \RaggedRight SUJET, COMPLÉMENT DIRECT ou OBLIQUE \\
    \hline
    \end{tabular}
\end{table}
