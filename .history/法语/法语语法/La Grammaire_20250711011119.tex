...
admettre, s’apercevoir, apprendre, calculer, comprendre, constater, contester, croire, découvrir, douter, estimer, évaluer, exclure, ignorer, imaginer, inventer, juger, oublier, penser, savoir, se rappeler, se souvenir (de), supposer, trouver, vérifier
&
...
\textbf{De communication :} \newline
affirmer, annoncer, avertir, dire, s’écrier, écrire, s’exclamer, expliquer, informer, murmurer, se plaindre (de), prétendre, prévenir, protester, raconter
&
...
choisir, contrôler, décider, décréter, garantir, renoncer (à)
&
...
\textbf{D’engagement :} \newline
assurer, s’engager (à), jurer, promettre
&
...
\textbf{Modaux :} \newline
il faut, il importe, nécessiter, il se peut
&
...
\end{tabular}
\end{adjustbox}
\caption{Verbes introduisant des complétives et leurs exemples}
\end{table}
