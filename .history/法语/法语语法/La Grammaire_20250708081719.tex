...
\hline
\textbf{sans complément :} \newline arriver, survenir & [Qu'il neige en avril] arrive parfois. \\
\hline
\textbf{avec un complément nominal :} \newline alourdir, améliorer, amuser, causer, changer, constituer, couter, ennuyer, entraîner, étonner, impliquer, nécessiter, réclamer, réjouir, résoudre, signifier, supposer, valoir & [Que Marie soit partie] complique [les choses]. \newline [Que Marie soit partie] ennuie [Paul]. \newline [Partir demain] réclame [toute une organisation]. \\
\hline
\textbf{avec un complément prépositionnel :} \newline conduire (à), convenir (à), découler (de), dépendre (de), déplaire (à), importer (à), influer (sur), plaire (à), suffire (à), sortir, venir (de) & [Persévérer] conduirait [à l'échec]. \newline [Que Marie soit partie] déplaît [à Paul]. \\
\hline
\textbf{avec un complément infinitif ou phrastique :} \newline commencer (à), conduire (à), être, finir (par), ressembler (à), revenir (à) & [Souffler] n'est pas [ jouer]. \newline [Partir] reviendrait [à démissionner]. \newline [Que tout va mal] commence [à se savoir]. \\
\hline % 表格底部的横线
\end{tabular}
