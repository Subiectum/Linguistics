...
\hline
déclarative & \textit{que} & indicatif ou subjonctif & \textit{Pierre pense [\underline{qu'elle a lu ces livres}].} \\
& & & \textit{Pierre regrette [\underline{qu'elle ait lu ces livres}].} \\
\hline
désidérative & \textit{que} & subjonctif & \textit{Pierre ordonne [\underline{qu'elle lise ces livres}].} \\
& & & \textit{Pierre souhaite [\underline{qu'elle réussisse}].} \\
\hline
interrogative & \textit{si} ou mot interrogatif & indicatif & \textit{Pierre se demande [\underline{quels livres elle a lus}].} \\
& & & \textit{Pierre se demande [\underline{qui est venu}].} \\
& & & \textit{Pierre se demande [\underline{si elle a lu ces livres}].} \\
\hline
exclamative & \textit{que} ou mot exclamatif & indicatif ou subjonctif & \textit{Pierre sait [\underline{comme elle est heureuse}].} \\
& & & \textit{Pierre regrette [\underline{qu'elle soit si triste}].} \\
\hline
\end{tabular}
\end{table}
