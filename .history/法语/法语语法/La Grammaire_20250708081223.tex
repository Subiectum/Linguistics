...
\begin{table}[H]
    ...
    \begin{tabular}{|>{\RaggedRight}p{5cm}|>{\RaggedRight}p{9cm}|}
        ...
        \hline
        \multicolumn{2}{|l|}{\textbf{sans complément :}} \\
        \hline
        arriver, survenir & [Qu'il neige en avril] arrive parfois. \\
        \hline
        \multicolumn{2}{|l|}{\textbf{avec un complément nominal :}} \\
        \hline
        ...
        \hline
        \multicolumn{2}{|l|}{\textbf{avec un complément prépositionnel :}} \\
        \hline
        ...
        \hline
        \multicolumn{2}{|l|}{\textbf{avec un complément infinitif ou phrastique :}} \\
        \hline
