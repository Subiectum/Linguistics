...
en que (indicatif) : & \\
\%à cause, à mesure, à moins, au lieu, après, à part, au point, attendu, au fur et à mesure, compte tenu, d'autant, dès, depuis, de même, du fait, du moment, étant donné, excepté, \% enre, hormis, \% moyennant, outre, pendant, sauf, selon, suivant, une fois, vu & \textit{attendu [que tu es parti]}, \textit{depuis [que tu es parti]}, \textit{dès [que tu pourras]}, \textit{pendant [que tu lis]}, \textit{sauf [qu'il était trop tard]}, \textit{selon [que tu viendras ou non]} \\
\hline
en que (subjonctif) : & \\
