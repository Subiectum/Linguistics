...
\begin{table}[H]
    ...
    \begin{adjustbox}{max width =\textwidth}
        ...
        \textbf{INTRODUCTEUR} & \textbf{FORMES} & \textbf{EXEMPLES} \\
        \hline
        préposition + infinitif & après & après avoir chanté \\
        \hline
        préposition ou syntagme prépositionnel + de + infinitif & avant, au moment, à l'instant, sur le point, etc. & avant de partir, au moment de partir, sur le point de démissionner \\
        \hline
        préposition + syntagme nominal & après, avant, dans, depuis, dès, durant, jusqu'à, pendant, etc. & avant le concert, après la sieste, dans son enfance, dès le réveil, durant la guerre, pendant la nuit \\
        \hline
        préposition ou syntagme prépositionnel + de & lors, à la suite, au cours, à compter, à partir, au moment, à l'instant, à l'époque, du temps, etc. & au moment de l'examen, lors de la manifestation \\
        \hline
        préposition + à & d'ici, suite & suite à votre démission \\
        \hline
        préposition + syntagme prépositionnel & jusque & jusqu'après la guerre \\
        \hline
        préposition à deux compléments & dès & dès le soleil levé \\
        \hline
        préposition + participe présent & en & Elle tricote [en chantant]. \\
        \hline
