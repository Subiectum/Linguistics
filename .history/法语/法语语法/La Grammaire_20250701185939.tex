...
\chapter{Verbe}
\begin{tabularx}{\textwidth}{|>{\bfseries}l|*{8}{X|}}
\hline
\multicolumn{1}{|c|}{} & \multicolumn{4}{c|}{\textbf{Indicative}} & \multicolumn{2}{c|}{\textbf{Subjunctive}} & \textbf{Conditional} & \textbf{Imperative} \\
\cline{2-9}
\multicolumn{1}{|c|}{} & Present & Simple past & Imperfect & Future & Present & Imperfect & Present & Present \\
\hline
je & 1S+e/s/x & PAST+ai/s & 1P+ais & FUT+ai & SUBJ+e & PAST+()sse & FUT+rais & -- \\
\hline
tu & 1S+es/s/x & PAST+a(s) & 1P+ais & FUT+as & SUBJ+es & PAST+()sses & FUT+rais & \shortstack{1S+s/t\\or\\SUBJ+e} \\
\hline
il/elle & 1S+e/t/- & PAST+a/t & 1P+ait & FUT+ra & SUBJ+e & PAST+(\^{})t & FUT+rait & -- \\
\hline
nous & 1P+ons & PAST+(\^{})mes & 1P+ions & FUT+rons & \shortstack{SUBJ+ions\\or\\1P+ions} & PAST+()ssions & FUT+rions & \shortstack{1P+ons\\or\\SUBJ+ons} \\
\hline
vous & 1P+ez & PAST+(\^{})tes & 1P+iez & FUT+rez & \shortstack{SUBJ+iez\\or\\1P+iez} & PAST+()ssiez & FUT+riez & \shortstack{1P+ez\\or\\SUBJ+ez} \\
\hline
ils/elles & 3P+ent & PAST+(\^{})rent & 1P+aient & FUT+ront & SUBJ+ent & PAST+()ssent & FUT+raient & -- \\
\hline
\end{tabularx}

\caption{French Verb Conjugation Template}
\label{tab:verb_conjugation}
\end{table}
