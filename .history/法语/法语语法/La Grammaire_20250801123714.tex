...
\hline
de similarité en comme & \textit{Il travaille [comme toi].} & \textit{Il travaille [comme avant].} & \textit{Il aime le cinéma [comme moi] [le théâtre].} 
\newline \textit{On va faire [comme si c'était vrai].} & \\
\hline
\end{tabular}
