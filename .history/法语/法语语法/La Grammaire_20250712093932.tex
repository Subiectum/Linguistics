...
\subsubsection{Les interrogatives partielles avec est-ce que}
\begin{enumerate}
...
\subsubsection{Les interrogatives partielles avec un verbe à sujet suffixé}
\begin{enumerate}
...
\subsubsection{Les interrogatives partielles avec mot interrogatif après le verbe}
非正式表达
\begin{enumerate}
    ...
    \begin{enumerate}
        \item 疑问词可只可出现在subordonnée circonstancielle ou relative中，不能出现在该句句首
        \begin{itemize}
        ...
        \begin{enumerate}
            ...
            \begin{itemize}
                ...
                \item l a dit [à qui Marie devait [s’adresser ◊]].
            \end{itemize}
        \end{enumerate}
    \end{enumerate}
\end{enumerate}
