...
\begin{table}[H]
    ...
    % Use tabularx and the new column type Y
    \begin{tabularx}{\textwidth}{l Y Y} % <-- Used Y here
        \toprule
        \textbf{PRÉPOSITIONS} & \textbf{VERBES} & \textbf{EXEMPLES} \\
        \midrule
        ...
        \addlinespace
        % Re-added the escaped '%' characters, as they should be handled by array/tabularx
