...
\begin{table}[H]
    ...
    \hline
    est simultanée & \textit{alors (que), aussi longtemps (que), comme, lorsque, pendant (que), quand, tandis que, alors (que), au moment (où), à l'instant (où), à l'époque (où), en même temps (que)}, etc. & Paul partit [lorsque le jour commença à décliner]. \\
    \hline
