...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Est-ce que vous voulez du thé ou du café ?
        \item Est-ce qu’on part ou est-ce qu’on ne part pas ?
    \end{itemize}
    \item avec un verbe à sujet suffixé
    \begin{itemize}
        \item Voulez-vous du thé ou du café ?
        \item Viendrez-vous à la remise du prix ou préférez-vous rester chez vous ?
    \end{itemize}
    \item les deux peuvent se combiner
    \begin{itemize}
        \item Est-ce que vous souhaitez parler, ou préférez-vous vous taire ?
    \end{itemize}
    \item si可代替第二个选项的引导词
    \begin{itemize}
...
\small
\renewcommand{\arraystretch}{1.4}
\begin{tabular}{|>{\bfseries}l|>{raggedright}p{3cm}|p{4cm}|p{3cm}|}
\hline
INTERROGATIVE & \textbf{SI} & \textbf{MOT ou SYNTAGME INTERROGATIF} & \textbf{SANS VERBE} \\
\hline
totale &
\textit{Je demande [si Luc vient].} &
--- &
--- \\
\hline
partielle &
--- &
\textit{Je demande [qui viendra].} \newline
\textit{Je demande [qui mange quoi].} &
\textit{Je demande [comment].} \\
\hline
alternative &
\textit{Je demande [si Luc vient ou non].} \newline
\textit{Je demande [si Léa va à Aix ou à Nice].} &
--- &
--- \\
\hline
\end{tabular}
\caption{Formes d’interrogatives indirectes : si, mot interrogatif, sans verbe}
\end{table}
