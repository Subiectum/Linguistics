...
\begin{longtable}{|p{0.45\textwidth}|p{0.45\textwidth}|} % Adjusted column width for better fit
\caption{Formes du Verbe et Autres Éléments Lexicaux}\label{tab:formes_verbes} \\
\hline
\textbf{FORME DU VERBE} & \textbf{AUTRE ÉLÉMENT LEXICAL} \\
\hline
\endfirsthead
\multicolumn{2}{c}%
...
$-$ indicatif (\textit{Paul viendra.}) & $-$ \\
$-$ infinitif (\textit{Et Paul de sursauter.}) & \\
\hline
$-$ impératif (\textit{Venez ici !}) & $-$ \textit{que} + subjonctif (\textit{Qu'il vienne !}) \\
...
\hline
$-$ indicatif (\textit{Comme il pleut !}) & $-$ mot exclamatif : \textit{ce que, combien, comme, comment, que,} \\
$-$ infinitif (\textit{Paul, faire tant de bruit !}) & \textit{quel, qu'est-ce que} \\
& $-$ adverbe ou adjectif intensif-exclamatif : \textit{si, tant, tel, tellement} \\
\hline
$-$ indicatif (\textit{Où allez-vous ?}) & $-$ mot interrogatif : \textit{combien, comment, lequel, où, pourquoi,} \\
$-$ indicatif à sujet suffixé (\textit{Viendrez-vous ?}) & \textit{quand, que, quel, qu'est-ce que, qu'est-ce qui, quoi, quoi,} \\
& \textit{qui est-ce que, qui est-ce qui} \\
