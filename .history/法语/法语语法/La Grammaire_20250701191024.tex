...
\textbf{tu} & \textbf{1S}+es/s/x & +a(s) & \textbf{1P}+ais & \textbf{FUT}+as & \textbf{3P/SUBJ}+es & \textbf{PAST}+()sses & \textbf{FUT}+rais & \textbf{1S}+s/t \textbf{SUBJ}+e\\
\hline
\textbf{il/elle} & \textbf{1S}+e/t/- & +a/t & \textbf{1P}+ait & \textbf{FUT}+ra & \textbf{3P/SUBJ}+e & \textbf{PAST}+(\^{})t & \textbf{FUT}+rait & \\
\hline
\textbf{nous} & \textbf{1P}+ons & + (\^{})mes & \textbf{1P}+ions & \textbf{FUT}+rons & \textbf{1P/SUBJ} +ions& \textbf{PAST}+ ()ssions & \textbf{FUT}+rions & \textbf{1P}+ons  \textit{or} \textbf{SUBJ}+ons \\

\hline
\textbf{vous} & \textbf{1P}+ez & + (\^{})tes & \textbf{1P}+iez & \textbf{FUT}+rez & \textbf{1P/SUBJ} +iez & \textbf{PAST}+ ()ssiez & \textbf{FUT}+riez & \textbf{1P}+ez  \textit{or} \textbf{SUBJ}+ez \\

\hline
\textbf{ils/elles} & \textbf{3P}+ent & + (\^{})rent & \textbf{1P}+aient & \textbf{FUT}+ront & \textbf{3P/SUBJ}+ ent & \textbf{PAST}+ ()ssent & \textbf{FUT}+raient & \\
\hline
\end{tabularx}
\end{table}
