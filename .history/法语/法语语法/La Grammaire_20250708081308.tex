...
\begin{table}[H]
    ...
    \begin{tabular}{|>{\RaggedRight}p{5cm}|>{\RaggedRight}p{9cm}|}
        ...
        \hline
        \textbf{sans complément :} & \cellcolor{gray!10} \\ % 灰色背景标识分类行
        \hline
        arriver, survenir & [Qu'il neige en avril] arrive parfois. \\
        \hline
        \textbf{avec un complément nominal :} & \cellcolor{gray!10} \\
        \hline
        ...
        \hline
        \textbf{avec un complément prépositionnel :} & \cellcolor{gray!10} \\
        \hline
        ...
        \hline
        \textbf{avec un complément infinitif ou phrastique :} & \cellcolor{gray!10} \\
        \hline
